...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(640, 40, 100, 65));
        pushButton->setMaximumSize(QSize(100, 65));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(640, 110, 100, 65));
        pushButton_2->setMaximumSize(QSize(100, 65));
        pushButton_3 = new QPushButton(centralwidget);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(640, 180, 100, 65));
        pushButton_3->setMaximumSize(QSize(100, 65));
        pushButton_4 = new QPushButton(centralwidget);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(640, 250, 100, 65));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Tourist Manager 1.0", nullptr));
